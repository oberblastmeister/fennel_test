local _0_0 = nil
do
  local name_0_ = "fennel_test.aniseed.test"
...
local function _1_(...)
  ...
  local function _1_()
    return {require("fennel_test.aniseed.core"), require("fennel_test.aniseed.nvim"), require("fennel_test.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "fennel_test.aniseed.core", nvim = "fennel_test.aniseed.nvim", str = "fennel_test.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "fennel_test.aniseed.test"
