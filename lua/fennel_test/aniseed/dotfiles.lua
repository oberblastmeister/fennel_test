local _0_0 = nil
do
  local name_0_ = "fennel_test.aniseed.dotfiles"
...
local function _1_(...)
  ...
  local function _1_()
    return {require("fennel_test.aniseed.compile"), require("fennel_test.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {compile = "fennel_test.aniseed.compile", nvim = "fennel_test.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "fennel_test.aniseed.dotfiles"
