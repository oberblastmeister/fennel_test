package.preload["fennel_test.aniseed.fennel.repl"] = package.preload["fennel_test.aniseed.fennel.repl"] or function(...)
  local utils = require("fennel_test.aniseed.fennel.utils")
  local parser = require("fennel_test.aniseed.fennel.parser")
  local compiler = require("fennel_test.aniseed.fennel.compiler")
  local specials = require("fennel_test.aniseed.fennel.specials")
...
package.preload["fennel_test.aniseed.fennel.specials"] = package.preload["fennel_test.aniseed.fennel.specials"] or function(...)
  local utils = require("fennel_test.aniseed.fennel.utils")
  local parser = require("fennel_test.aniseed.fennel.parser")
  local compiler = require("fennel_test.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "fennel_test.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["fennel_test.aniseed.fennel.compiler"] = package.preload["fennel_test.aniseed.fennel.compiler"] or function(...)
  local utils = require("fennel_test.aniseed.fennel.utils")
  local parser = require("fennel_test.aniseed.fennel.parser")
  local friend = require("fennel_test.aniseed.fennel.friend")
  local unpack = (_G.unpack or table.unpack)
  local scopes = {}
...
package.preload["fennel_test.aniseed.fennel.friend"] = package.preload["fennel_test.aniseed.fennel.friend"] or function(...)
...
package.preload["fennel_test.aniseed.fennel.parser"] = package.preload["fennel_test.aniseed.fennel.parser"] or function(...)
  local utils = require("fennel_test.aniseed.fennel.utils")
  local friend = require("fennel_test.aniseed.fennel.friend")
  local unpack = (_G.unpack or table.unpack)
...
local utils = nil
package.preload["fennel_test.aniseed.fennel.utils"] = package.preload["fennel_test.aniseed.fennel.utils"] or function(...)
...
utils = require("fennel_test.aniseed.fennel.utils")
local parser = require("fennel_test.aniseed.fennel.parser")
local compiler = require("fennel_test.aniseed.fennel.compiler")
local specials = require("fennel_test.aniseed.fennel.specials")
local repl = require("fennel_test.aniseed.fennel.repl")
...
do
  ...
  local module_name = "fennel_test.aniseed.fennel.macros"
  local _ = nil
  local function _0_()
    return mod
  end
