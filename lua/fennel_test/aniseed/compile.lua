local _0_0 = nil
do
  local name_0_ = "fennel_test.aniseed.compile"
...
local function _1_(...)
  ...
  local function _1_()
    return {require("fennel_test.aniseed.core"), require("fennel_test.aniseed.fennel"), require("fennel_test.aniseed.fs"), require("fennel_test.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "fennel_test.aniseed.core", fennel = "fennel_test.aniseed.fennel", fs = "fennel_test.aniseed.fs", nvim = "fennel_test.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "fennel_test.aniseed.compile"
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "fennel_test.aniseed.macros"
